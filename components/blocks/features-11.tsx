...
export function Features() {
    return (
        <section className="bg-[#fcf6ef] pt-8 pb-16 sm:pt-12 sm:pb-24 md:pt-16 md:pb-32 overflow-hidden">
            <div className="mx-auto max-w-5xl px-4 sm:px-6">
                ...
                >
                    {/* Top Left Card - Real-time Pattern Detection */}
                    ...
                    {/* Bottom Right Card - 50+ Integrations */}
